      ...
      <div className={styles.help_box}>
         ...
         <p className={styles.skills_content}>
            ...
            <span className={styles.col_3}>
               <span className={styles.col_4}>&#91;</span>“JavaScript”, “TypeScript”, “Python”
               ...
               <p className={styles.col_2}>
                  ...
                  <span className={styles.col_3}>"data-structures", "algorithms"</span>
                  <span className={styles.col_4}>&#93;</span>
            ...
            "Array", "Linked list", "Stack", "Queue", "Tree", "Heap"
               ...
               <span>
                  ...
                  <span className={styles.col_4}>&#91;</span>“ReactJS”, “NextJS”, “ReactNative”, “HTML”, “Css”, “Scss”,
                  <span className={styles.col_4}>&#93;</span>,
               </span>
               {/*
                * ---------------
...
export function HelpCmd() {
   return (
      <div className={styles.help_cmd}>
         ...
         <p>
            <span className={styles.col_2}>skills:</span> displays all technical skills
         </p>
         <p>
...
export function AboutCmd() {
   return (
      <div className={styles.about_cmd}>
         ...
         <p>
            currently a <span className={styles.col_4}>student</span>, learning and developing new skills. fuelled by a
            passion for making cool websites and applications. proficient in technologies like ReactJS, NextJS. some of
